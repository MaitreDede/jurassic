...
namespace Jurassic.Library
{
	...
	public partial class PromiseConstructor
	{
		...
		private static ObjectInstance __STUB__Construct(ScriptEngine engine, object thisObj, object[] args)
		{
			...
			{
				case 0:
					return ((PromiseConstructor)thisObj).Construct(Undefined.Value);
				default:
					return ((PromiseConstructor)thisObj).Construct(args[0]);
			}
		}
		...
		private static object __STUB__All(ScriptEngine engine, object thisObj, object[] args)
		{
			...
			{
				case 0:
					return ((PromiseConstructor)thisObj).All(Undefined.Value);
				default:
					return ((PromiseConstructor)thisObj).All(args[0]);
			}
		}
		...
		private static object __STUB__Race(ScriptEngine engine, object thisObj, object[] args)
		{
			...
			{
				case 0:
					return ((PromiseConstructor)thisObj).Race(Undefined.Value);
				default:
					return ((PromiseConstructor)thisObj).Race(args[0]);
			}
		}
